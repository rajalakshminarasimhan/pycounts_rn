from pycounts_rn.pycounts_rn import count_words
from pycounts_rn.plotting import plot_words
from pycounts_rn.datasets import get_flatland
import matplotlib
...
def test_integration():
    ...
    assert isinstance(fig, matplotlib.container.BarContainer), \
        "Wrong plot type"
    assert len(fig.datavalues) == 10, \
        "Incorrect number of bards plotted"
